	...
	<form method="POST" action="display.php" enctype="multipart/form-data">
		<div class="header" style="width: 100%; height: 100px; border-bottom: 2px solid black;">
		    <div class="header-left" style="width: 30%; height: 100px; float: left;">
		    	<h4><img src="1.jfif" width="100" height="100" style="padding: 10px;"><a href="maindisplay.php" style="color: black;">Movie Station</a></h4>
		    </div>
...
<td><?php echo'<img src="data:image/jpeg;base64,'.base64_encode( $row['poster'] ).'"/>;;
<td>
